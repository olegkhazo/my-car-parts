<template>
  <div class="form-fields-section">
    <span class="type-of-communication-header-text"
      >Choose how you want to receive responses from sellers:</span
    >
    ...
    <button class="gray-btn" @click.prevent="checkTheFormFields(true, 4)">
      Send request
    </button>
  </div>
</template>
